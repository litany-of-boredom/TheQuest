let output = "";
let hash = "6fa599fe7b02fec029e98dfa0f64c6ec946cc0ebc57916355dcaaf27bcac5a16";
let solved = false;
...
document.querySelector("#submit-answer").onclick = function()
{
    ...
    {
        solved = true;
        document.querySelector("#correct-msg").innerHTML = "Correct!";
...
function postComment()
{
    ...
    let postData = "user_id=" + user_id + "&puzzle_id=" + puzzle_id + "&comment=" + comment;
    console.log(postData);
	ajaxPost("addComment.php", postData, function(results)
	{
